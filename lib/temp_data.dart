...
Category menCategory = Category.fromJson(menCateJson);
Category womenCategory = Category.fromJson(womenCateJson);
Category petCategory = Category.fromJson(petCateJson);
...
List<Product> recommendProducts = [
  products[3], products[1], products[0], products[4], products[10],
];
